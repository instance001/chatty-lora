...
pub const TRAINING_LANES: &[TrainingLaneDefinition] = &[
    ...
    TrainingLaneDefinition {
        backend_id: backend_registry::AI_TOOLKIT_WAN22_5B_BACKEND_ID,
        label: "Wan 2.2 TI2V 5B lane",
        task: "ti2v-5B",
        family_id: "wan",
        dataset_kind: TrainingDatasetKind::Video,
        defaults: LaneDefaults {
            ...
            frame_extraction: Some("head"),
            blocks_to_swap: 0,
            route_label: "Planned middleweight Wan 2.2 route",
            route_summary: "This lane is meant to become the more achievable Wan 2.2 end-to-end path than the heavier 14B lanes, but the current Chatty-lora support is still scaffold-level until the local AI Toolkit workflow is proven.",
            hardware_note: "Treat this as a promising but still unverified Wan 2.2 lane while the first real AI Toolkit handoff is being wired in.",
            exploratory: true,
        },
    },
    TrainingLaneDefinition {
        backend_id: backend_registry::AI_TOOLKIT_WAN22_5B_IMAGE_BACKEND_ID,
        label: "Wan 2.2 TI2V 5B image visual lane",
        task: "ti2v-5B",
        family_id: "wan",
        dataset_kind: TrainingDatasetKind::Image,
        defaults: LaneDefaults {
            ...
            frame_extraction: None,
            blocks_to_swap: 0,
            route_label: "Planned image-first Wan 2.2 route",
            route_summary: "This lane is the simpler image-first sibling to the Wan 2.2 5B video route. It should be the easier path to prove the AI Toolkit runtime and LoRA flow before pushing temporal training.",
            hardware_note: "Treat this as the practical first proving ground for Wan 2.2 on the current local stack.",
            exploratory: true,
        },
    },
];
